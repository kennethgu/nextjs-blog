  ...
  return (
    ...
    <main className="flex lg:flex-row flex-col py-24 lg:w-3/5 md:w-1/2 w-3/4 text-left mx-auto">
      ...
      <Link href="/notes">
        ...
        <p className="lg:w-50">
        <span className="font-bold">Saturday, Sept 30:&nbsp;</span>
          Not a super interesting day but learned that Uniqlo in Japanese is pronounced Yunikuro.
        </p>
        
        <p className="lg:w-50">
        <span className="font-bold">Friday, Sept 29:&nbsp;</span>
          Learned about Caligula according to the Roman Empire show on Netflix. Not 100% sure how accurate the show was, but shows how his family was killed by Tiberius and how he was spared and raised by Tiberius.
        </p>

        <p className="lg:w-50">
        <span className="font-bold">Thursday, Sept 28:&nbsp;</span>
          Learned about the tournament method for distribution testing learning in 6.S896: if we know that the true distribution is contained in some set of distributions, we can create an <InlineMath math="\epsilon" />-cover of that set (every distribution is at most <InlineMath math="\epsilon"/> away from some representative) and essentially create a tournament between representative distributions. If we use TV distance, <InlineMath math="O(\log (N/\delta) / \epsilon^2)"/> samples suffice to learn a distribution from the set to <InlineMath math="\epsilon"/> in TV distance with at least <InlineMath math="1-\delta"/> probability where <InlineMath math="N"/> is the cardinality of the smallest covering.
        </p>
